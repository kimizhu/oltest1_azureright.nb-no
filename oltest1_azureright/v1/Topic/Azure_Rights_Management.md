...
<caps:SxS xmlns:caps="http://schemas.microsoft.com/build/caps/2013/11">
  <caps:SxSTarget locale="nb-NO">
    <developerConceptualDocument xsi:schemaLocation="http://ddue.schemas.microsoft.com/authoring/2003/5 http://dduestorage.blob.core.windows.net/ddueschema/developer.xsd" xmlns="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
      <introduction>
        <para>
          <caps:sentence sentenceid="62b83eea4fc0746f132ff6c8d4a52b84" id="tgt1" class="tgtSentence">Denne siden introduserer den tekniske dokumentasjonen som er angitt for Microsoft <token>aad_rightsmanagement_1</token> (Azure RMS), som hjelper deg med å beskytte organisasjonens sensitiv informasjon mot uautorisert tilgang og kontrollere hvordan denne informasjonen brukes.</caps:sentence>
          <caps:sentence sentenceid="23b58def11b45727d3351702515f86af" id="tgt2" class="tgtSentence">
            <token>aad_rightsmanagement_1</token> er en cloud-tjeneste, og er integrert i andre Microsoft cloud-tjenester og programmer, for eksempel Office 365 og Azure Active Directory.</caps:sentence>
          <caps:sentence sentenceid="145e719c453fbadadee79768f74667aa" id="tgt3" class="tgtSentence"> Men kan det også brukes med din lokale programmer og tjenester.</caps:sentence>
        </para>
        <para>
          <caps:sentence sentenceid="c6fa2923fc013e88430215867fa3b41f" id="tgt4" class="tgtSentence">
            <token>aad_rightsmanagement_2</token> bruker kryptering, identitet og authorization policyer for å sikre filer og e-post.</caps:sentence>
          <caps:sentence sentenceid="6cee999ea54670dc3aaf3fa7bfdf7566" id="tgt5" class="tgtSentence"> Sammenlignet med standard access-kontroller, for eksempel NTFS-tillatelser, beskyttelse som brukes ved hjelp av <token>aad_rightsmanagement_2</token> forblir med filer og e-postmeldinger, uavhengig av plasseringen, innenfor eller utenfor din organisasjon, nettverk, filservere og programmer.</caps:sentence>
          <caps:sentence sentenceid="3cea98f77e893eb1025f89567a366d77" id="tgt6" class="tgtSentence"> Denne løsningen for beskyttelse av informasjon holder deg i kontroll av data, selv når den er delt med andre.</caps:sentence>
        </para>
        <para>
          <caps:sentence sentenceid="3d1e430f66ef0a41b3c0d4361753146d" id="tgt7" class="tgtSentence">Du kan for eksempel konfigurere en fil slik at den kan bare åpnes av personer i organisasjonen, eller kontroll om filen kan redigeres, eller begrenset til skrivebeskyttet, eller hindre at det skrives ut.</caps:sentence>
          <caps:sentence sentenceid="a1d4b6ea938e5c3193bcc436be24f8c0" id="tgt8" class="tgtSentence"> Du kan konfigurere e-post på samme måte, og i tillegg hindre videre eller forhindre bruken av alternativet svar til alle.</caps:sentence>
          <caps:sentence sentenceid="76c61c663112d6aabc8b0558688c8514" id="tgt9" class="tgtSentence"> Disse oppgavene for beskyttelse kan forenklet og strømlinjeformet ved hjelp av standardiserte policymaler.</caps:sentence>
        </para>
        <para>
          <caps:sentence sentenceid="31d23eeb49a60f86a1641f17c6570b72" id="tgt10" class="tgtSentence">
      For en dypere forståelse og noen eksempler, kan du se <link xlink:href="aeeebcd7-6646-4405-addf-ee1cc74df5df">What is Azure Rights Management?</link></caps:sentence>
        </para>
        <para>
          <caps:sentence sentenceid="0d618ca3ca5b0a48f105c1e37165a023" id="tgt11" class="tgtSentence">Bruk informasjonen nedenfor for å lære mer om <token>aad_rightsmanagement_1</token> og distribuere den for organisasjonen:</caps:sentence>
        </para>
        <list class="bullet">
          <listItem>
            <para>
        ...
        <para>
          <caps:sentence sentenceid="8f8764b84fbfe3fb41a1de8bd2151a22" id="tgt12" class="tgtSentence">For ytterligere ressurser, kan du se <link xlink:href="7cc73d92-27d6-49ff-a8ab-2fae73519b4b">Information and Support for Azure Rights Management</link>.</caps:sentence>
        </para>
      </introduction>
      <section>
        <title>
          <caps:sentence sentenceid="b75b1651ff8c1f6e857670d70de57727" id="tgt13" class="tgtSentence">Også kjent som...</caps:sentence>
        </title>
        <content>
          <para>
            <caps:sentence sentenceid="0bb50d5ace4abd536a35235fd9cca548" id="tgt14" class="tgtSentence">Azure Rights Management er også kjent som <legacyItalic>Azure Rights Management-tjenesten</legacyItalic>, men fordi den kjører som en tjeneste i Azure, "tjenesten" er ofte utelatt fra navnet.</caps:sentence>
            <caps:sentence sentenceid="4ec4858d185533976ae0410b2d35079b" id="tgt15" class="tgtSentence"> Det er sky-versjon av <legacyItalic>Active Directory Rights Management Services</legacyItalic> (AD RMS), som først ble utgitt som <legacyItalic>Windows Rights Management Services</legacyItalic> (Windows RMS).</caps:sentence>
          </para>
          <para>
            <caps:sentence sentenceid="0726a4db7b39858b6c4062cb42e94fe2" id="tgt16" class="tgtSentence">Fordi RMS er en velkjent forkortelse for sine forgjengere, Azure Rights Management er ofte forkortet til <legacyItalic>Azure RMS</legacyItalic>.</caps:sentence>
          </para>
          <para>
            <caps:sentence sentenceid="951d003f6152823990af843b34aa46e3" id="tgt17" class="tgtSentence">Azure Rights Management ble opprinnelig kalt <legacyItalic>Windows Azure Active Directory Rights Management</legacyItalic> (ofte forkortet til <legacyItalic>Windows Azure AD Rights Management</legacyItalic>), deretter  <legacyItalic>Windows Azure Rights Management</legacyItalic>, og nå til slutt <legacyItalic>Azure Rights Management</legacyItalic>.</caps:sentence>
          </para>
          <para>
            <caps:sentence sentenceid="ae8b2b285d98ab9534ef325989bd0813" id="tgt18" class="tgtSentence">Du kan også se referanser til <legacyItalic>Information Rights Management,</legacyItalic> ofte forkortet til <legacyItalic>IRM</legacyItalic>.</caps:sentence>
            <caps:sentence sentenceid="bcf8f7f6e8efe34a2816544f253dc99e" id="tgt19" class="tgtSentence"> Dette er Office-implementeringen av Rights Management, som støtter både Azure RMS og AD RMS.</caps:sentence>
            <caps:sentence sentenceid="814cd385574d9159ca8935f57babd54f" id="tgt20" class="tgtSentence">  Når først ble publisert Azure RMS, det kan bare brukes med Office 365, for eksempel med et abonnement på Office 365-E3.</caps:sentence>
            <caps:sentence sentenceid="21c6900dba0d93d29042f515dd3cd695" id="tgt21" class="tgtSentence"> Nå, Azure RMS utvides til andre abonnementer, for eksempel Enterprise mobilitet Suite (EMS) støtte inkluderer nå 2016 for Office, Office-2013, Office 2010, lokale versjoner av SharePoint og Exchange og Azure RMS kan beskytte alle filtyper.</caps:sentence>
            <caps:sentence sentenceid="3ce055386165dac9a926371c350ecfed" id="tgt22" class="tgtSentence"> Hvis du vil ha mer informasjon, se  <link xlink:href="2cdc7bde-4044-4021-b887-11476f99afd9">How Applications Support Azure Rights Management</link>.</caps:sentence>
          </para>
          <para>
            <caps:sentence sentenceid="483562e5c3f5a51c6ece6ac16a3e8b0f" id="tgt23" class="tgtSentence">Du kan også se tilfeldige referanser til <legacyItalic>Microsoft Rights Management</legacyItalic>, eller <legacyItalic>Microsoft Rights Management services</legacyItalic>, som er en kollektiv term som kan inkludere både Azure RMS og AD RMS.</caps:sentence>
            <caps:sentence sentenceid="62590b7cc80fa58960258871f90025a1" id="tgt24" class="tgtSentence">  Den "<legacyItalic>ny Microsoft RMS</legacyItalic>" ble en populær etikett som noen ganger ble brukt da Azure Rights Management ble offisielt utgitt, til å fremheve det nye enkelt distribusjon sammenlignet med sine forgjengere lokale.</caps:sentence>
          </para>
          <alert class="tip">
            <para>
              <caps:sentence sentenceid="da41105f4520ac7aa5ba99aad81c8f23" id="tgt25" class="tgtSentence">Du finner disse betingelsene (og mer) i <link xlink:href="742877bf-26f5-40e3-b1f7-8475e7c3ce11">Terminology for Azure Rights Management</link>.</caps:sentence>
            </para>
          </alert>
          <para>
            <caps:sentence sentenceid="d2584214cdff2107001a9881c3f0d321" id="tgt26" class="tgtSentence">Som en informasjon beskyttelse bedriftsløsning gir Microsoft Rights Management services ikke digital rights management (DRM)-løsninger som vanligvis beskytter mot ulovlig distribusjon av programvaren digital.</caps:sentence>
          </para>
        </content>
      </section>
